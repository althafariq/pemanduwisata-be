...
func Seed(db *sql.DB) {
	...
	_, err = db.Exec(`INSERT INTO destinations (id, name, location, description)
	VALUES
	...
	_, err = db.Exec(`INSERT INTO budaya (id, name, description, destination_id)
	VALUES
	('81', 'Suku tengger', 'Suku Tengger merupakan masyarakat yang berasal dari dataran tinggi Bromo-Tengger-Semeru. Mereka juga biasa disebut orang Tengger. Penduduknya menempati wilayah Kabupaten Pasuruan, Lumajang, Probolinggo, dan Malang.
	Bagi orang Tengger, Gunung Bromo atau yang juga disebut Gunung Brahma diyakini sebagai gunung suci. Setiap tahun, masyarakat Tengger mengadakan sebuah upacara Yadnya Kasada di bawah kaki Gunung Bromo, tepatnya di Pura Luhur Poten Bromo dan dilanjutkan ke puncak gunung.', '1001'),

	('82', 'Suku Osing', 'Suku Osing merupakan suku asli yang berasal dari Kabupaten Banyuwangi. Suku Osing memiliki budaya yang beraneka ragam. Mulai dari adat istiadat, bahasa, manuskrip, kesenian, tradisi lisan, ritus, pengetahuan, teknologi dan permainan Tradisional.', '1002')
	;`)
	...
	_, err = db.Exec(`INSERT INTO photos (destination_id, path)
	VALUES
	('1001', 'media/destination/gunungbromo.png')
	;`)
	if err != nil {
		panic(err)
	}
	...
	VALUES
	('2', '1001', '5', 'Tempatnya bagus, pemandangan indah, dan suasana sejuk. Saya sangat suka dengan tempat ini. Saya sangat merekomendasikan tempat ini untuk anda yang ingin berlibur.'),
	('2', '1001', '4', 'Tempatnya bagus, pemandangan indah, dan suasana sejuk. Saya sangat suka dengan tempat ini. Saya sangat merekomendasikan tempat ini untuk anda yang ingin berlibur.'),
	('2', '1002', '4', 'Tempatnya bagus, pemandangan indah, dan suasana sejuk. Saya sangat suka dengan tempat ini. Saya sangat merekomendasikan tempat ini untuk anda yang ingin berlibur.')
	;`)
